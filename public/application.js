...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://glacial-island-77826.herokuapp.com',
...
var displayCreateForms = function displayCreateForms(e) {
  e.preventDefault();
...
var displayUpdateForms = function displayUpdateForms(e) {
  $('#updateModal').modal('show');
};

var displaySearchForms = function displaySearchForms(e) {
  $('#search-by-address').css('display', 'inline-block');
};

var onSearchByName = function onSearchByName(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  api.searchByName(data).then(ui.onSearchByNameSuccess).catch(ui.onGetFailure);
};

var onStoresIndex = function onStoresIndex(e) {
  api.storesIndex().then(ui.onStoresIndexSuccess).catch(ui.onGetFailure);
};

var onCreateStore = function onCreateStore(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  api.createStore(data).then(ui.onCreateSuccess).catch(ui.onCreateFailure);
};

var onUpdateStore = function onUpdateStore(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  console.log(data.store.id);
  api.updateStore(data).then(ui.onUpdateSuccess).catch(ui.onUpdateFailure);
};

var onShowStore = function onShowStore(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  console.log(data);
  console.log(data.address);
  // get store_id from address to show store
  api.showStore(data).then(ui.onShowSuccess).catch(ui.onShowFailure);
};

var onSaveStoreToUser = function onSaveStoreToUser(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  console.log(data);
  api.saveStoreToUser(data.stores_user).then(ui.onSaveSuccess).catch(ui.onSaveFailure);
};

var onDeleteStore = function onDeleteStore(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  api.deleteStore(data.stores_user.store_id).then(function (render) {
    return onStoresIndex(render);
  }).then(ui.onDeleteSuccess).catch(ui.onDeleteFailure);
};

module.exports = {
  displayCreateForms: displayCreateForms,
  displayUpdateForms: displayUpdateForms,
  displaySearchForms: displaySearchForms,
  onSearchByName: onSearchByName,
  onStoresIndex: onStoresIndex,
  onCreateStore: onCreateStore,
  onUpdateStore: onUpdateStore,
  onShowStore: onShowStore,
  onSaveStoreToUser: onSaveStoreToUser,
...
var storeData = __webpack_require__(1);

var renderOneStore = function renderOneStore(store) {
  var wifi = !store.wifi ? 'unavailable' : 'available';
...
var renderStores = function renderStores(data) {
  $('.form-block').hide();
  $('.form-inline').hide();
  $('#search-form').css('dislplay', 'flex');
  $('#my-stores').css('display', 'flex');
  $('.card-content').empty();
  data.stores.reverse().forEach(function (store) {
    var wifi = !store.wifi ? 'unavailable' : 'available';
...
var onSearchByNameSuccess = function onSearchByNameSuccess(data) {
  $('#message').css('display', 'none');
  renderStores(data);
};

var onSearchByNameFailure = function onSearchByNameFailure(err) {
...
var onStoresIndexSuccess = function onStoresIndexSuccess(data) {
  $('#message').css('display', 'none');
  renderStores(data);
...
var onSaveFailure = function onSaveFailure(err) {
...
var onDeleteFailure = function onDeleteFailure(err) {
  $('#message').text('could not remove. ' + err);
};

module.exports = {
  onSearchByNameSuccess: onSearchByNameSuccess,
  onSearchByNameFailure: onSearchByNameFailure,
  onGetFailure: onGetFailure,
  onStoresIndexSuccess: onStoresIndexSuccess,
...
var storeEvents = __webpack_require__(4);
var addressEvents = __webpack_require__(14);
...
var displaySignUpForm = function displaySignUpForm(e) {
  e.preventDefault();
...
var displaySignInForm = function displaySignInForm(e) {
  e.preventDefault();
  $('#sign-in').css('display', 'none');
  $('#sign-up').css('display', 'none');
...
var displayChangePasswordForm = function displayChangePasswordForm(e) {
  e.preventDefault();
...
module.exports = {
  ...
  displayChangePasswordForm: displayChangePasswordForm,
  onSignUp: onSignUp,
  onSignIn: onSignIn,
...
var onChangePasswordFailure = function onChangePasswordFailure(err) {
...
var onSignOutFailure = function onSignOutFailure(err) {
...
var storesIndex = function storesIndex() {
  return $.ajax({
...
var updateStore = function updateStore(data) {
  return $.ajax({
...
var showStore = function showStore(data) {
  return $.ajax({
...
var saveStoreToUser = function saveStoreToUser(data) {
  return $.ajax({
    url: config.apiUrl + '/stores_user',
    method: 'POST',
    crossDomain: true,
...
module.exports = {
  ...
  showStore: showStore,
  saveStoreToUser: saveStoreToUser,
...
var storeUi = __webpack_require__(5);
var storeData = __webpack_require__(1);

var onCreateAddress = function onCreateAddress(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  api.createAddress(data).then(ui.createAddressSuccess).catch(ui.createAddressFailure);
};

var onUpdateAddress = function onUpdateAddress(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  api.updateAddress(data).then(ui.onUpdateSuccess).catch(ui.onUpdateFailure);
};

var onShowAddress = function onShowAddress(e) {
  e.preventDefault();
  var data = getFormFields(e.target);
  api.showAddress(data).then(ui.showAddressSuccess).then(ui.showAddressFailure);
};
...
var showAddress = function showAddress(data) {
  console.log(data);
  return $.ajax({
    url: config.apiUrl + '/addresses/',
    method: 'GET',
...
var renderAddressInfo = function renderAddressInfo(data) {
...
var createAddressSuccess = function createAddressSuccess(data) {
  $('#create-address').hide();
  storeData.data = data.address;
  renderAddressInfo(data.address);
};

var createAddressFailure = function createAddressFailure(err) {
...
var onUpdateFailure = function onUpdateFailure(err) {
  $('#message').text('Could not update this address: ' + err);
};

var showAddressSuccess = function showAddressSuccess(data) {
  storeData.data = data.address;
  $('#search-by-address').hide();
  storeEvents.onShowStore(storeData.data);
};

var showAddressFailure = function showAddressFailure(err) {
  $('#message').text('could execute. ' + err);
};

module.exports = {
  createAddressSuccess: createAddressSuccess,
  createAddressFailure: createAddressFailure,
  onUpdateSuccess: onUpdateSuccess,
  onUpdateFailure: onUpdateFailure,
  showAddressSuccess: showAddressSuccess,
  showAddressFailure: showAddressFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
